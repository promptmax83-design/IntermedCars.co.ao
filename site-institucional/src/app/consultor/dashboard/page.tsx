        ...
        <div className="bg-white rounded-xl border border-slate-200/60 overflow-hidden">
          ...
          {negotiations.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-sm font-medium text-slate-800">Nenhuma negociacao pendente</p>
              <p className="text-xs text-slate-500 mt-1">Negociacoes pendentes aparecerao aqui.</p>
            </div>
          ) : (
