    ...
    <div className="min-h-screen bg-[#F8F9FA]">
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800">Contacto</h1>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              {submitted && (
                <div className="mb-6 p-4 bg-[#10b981]/10 border border-[#10b981]/30 rounded-xl text-[#10b981] text-sm">
                  ...
                  <button
                    ...
                    className="ml-3 underline hover:text-slate-800 transition-colors"
                  >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-[#52525b] focus:ring-2 focus:ring-[#10b981] focus:border-transparent outline-none transition"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 focus:ring-2 focus:ring-[#10b981] focus:border-transparent outline-none transition"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 placeholder-[#52525b] focus:ring-2 focus:ring-[#10b981] focus:border-transparent outline-none transition resize-none"
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-bold text-slate-800 mb-6">Informações</h2>
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-slate-800">Showroom</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 text-sm">+244 222 123 456</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-[#10b981]/10 rounded-xl flex items-center justify-center flex-shrink-0">
              ...
              <div className="bg-slate-50 rounded-2xl p-6 border border-slate-200">
                <h3 className="font-bold text-slate-800 mb-3">Avaliação Express</h3>
                <p className="text-slate-500 text-sm mb-4">
                  Precisa de uma avaliação rápida? Ligue-nos ou envie uma foto
                  da sua viatura por WhatsApp.
                </p>
                <div className="bg-[#F8F9FA] rounded-xl p-4 text-center border border-slate-200">
