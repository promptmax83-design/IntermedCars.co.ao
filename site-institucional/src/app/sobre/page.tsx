...
export const metadata: Metadata = {
  ...
  description:
    "Conheça a história e equipa da IntermedCars, mediação automóvel de confiança.",
};
...
const timeline = [
  {
    ...
    titulo: "Fundação",
    descricao:
      "A IntermedCars nasce em Lisboa com a missão de profissionalizar a mediação automóvel.",
  },
  {
    ano: "2017",
    titulo: "Expansão",
    descricao:
      "Abrimos o nosso showroom de 800m2 em Alfragide com mais de 50 viaturas em exposição.",
  },
  {
    ano: "2020",
  ...
  return (
    <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-muted mb-4">
                ...
                profissional no mercado português.
              </p>
              <p className="text-muted mb-4">
                Começámos com uma pequena equipa de 3 pessoas e um sonho: mudar
                a forma como os portugueses compram e vendem viaturas. Hoje,
      ...
      <section className="py-20 bg-light">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-accent font-semibold tracking-widest uppercase text-sm text-center mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm text-center">
              ...
              <p className="text-muted">
                Ser a referência em mediação automóvel em Portugal, reconhecida
