      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#fafafa] mb-6">A Nossa História</h2>
              ...
              <div className="flex gap-8">
                <div>
                  ...
                  <p className="text-sm text-[#71717a]">Viaturas vendidas</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-[#10b981]">98%</p>
                  <p className="text-sm text-[#71717a]">Satisfação</p>
                </div>
                <div>
                  <p className="text-3xl font-bold text-[#10b981]">10+</p>
                  <p className="text-sm text-[#71717a]">Anos</p>
                </div>
              </div>
            </div>
            <div className="bg-zinc-900/50 rounded-2xl p-8 border border-zinc-800/80">
              <div className="relative border-l-2 border-[#10b981] ml-4 space-y-8">
                {timeline.map((item) => (
                  <div key={item.ano} className="relative pl-8">
                    ...
                    <h3 className="font-bold text-lg text-[#fafafa]">{item.titulo}</h3>
                    <p className="text-[#a1a1aa] text-sm">{item.descricao}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-20 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800/80 text-center">
              ...
              <h3 className="text-lg font-bold text-[#fafafa] mb-3">Missão</h3>
            ...
            <div className="bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800/80 text-center">
              ...
              <h3 className="text-lg font-bold text-[#fafafa] mb-3">Visão</h3>
              <p className="text-[#a1a1aa]">
            ...
            <div className="bg-zinc-900/50 p-8 rounded-2xl border border-zinc-800/80 text-center">
              ...
              <h3 className="text-lg font-bold text-[#fafafa] mb-3">Valores</h3>
              <p className="text-[#a1a1aa]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={pessoa.nome}
                className="bg-zinc-900/50 border border-zinc-800/80 rounded-2xl p-6 text-center hover:border-zinc-700/80 transition-colors"
              >
                <div className="w-20 h-20 bg-[#060608] rounded-full mx-auto mb-4 flex items-center justify-center border border-zinc-800/80">
                ...
                <h3 className="font-bold text-lg text-[#fafafa]">{pessoa.nome}</h3>
                <p className="text-[#71717a] text-sm">{pessoa.cargo}</p>
              </div>
            ))}
          </div>
        </div>
