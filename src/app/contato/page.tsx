...
export const metadata: Metadata = {
  ...
  description: "Entre em contacto com a IntermedCars. Estamos prontos para ajudá-lo.",
};
    ...
    <div>
      <section className="bg-primary text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-accent font-semibold tracking-widest uppercase text-sm mb-2">Fale Connosco</p>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted text-sm">Av. da Liberdade, 1100<br />1250-146 Lisboa</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-accent bg-opacity-10 rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted text-sm">geral@intermedcars.pt</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-accent bg-opacity-10 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-muted text-sm">Seg - Sex: 9:00 - 19:00<br />Sáb: 10:00 - 14:00</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-light rounded-xl p-6">
                ...
                <p className="text-muted text-sm mb-4">
                  Precisa de uma avaliação rápida? Ligue-nos ou envie uma foto da sua viatura por WhatsApp.
                </p>
                <div className="bg-white rounded-lg p-4 text-center border border-gray-100">
                  <p className="text-sm text-muted">WhatsApp</p>
                  <p className="text-accent font-bold text-lg">+351 912 345 678</p>
                </div>
              </div>
            </div>
          </div>
