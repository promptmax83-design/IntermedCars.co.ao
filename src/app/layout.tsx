...
export const metadata: Metadata = {
  ...
  description:
    "Compra, venda e mediação de viaturas com cofre fiduciário e segurança total.",
};
        ...
        <div className="flex h-screen overflow-hidden">
          <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200 shrink-0">
            <div className="p-4 border-b border-gray-100">
              <Link href="/" className="flex items-center gap-2">
                <span className="w-9 h-9 bg-accent rounded-lg flex items-center justify-center text-primary font-bold text-sm">
                  IC
                </span>
            ...
            <nav className="flex-1 p-3 space-y-1">
              ...
              <div className="pt-4 border-t border-gray-100 mt-4 space-y-1">
                <Link
                  href="/admin"
                  className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-500 hover:bg-gray-100"
                >
            ...
            <div className="p-4 border-t border-gray-100">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-accent font-bold text-sm">
                  JF
                </div>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            <header className="lg:hidden flex items-center justify-between px-4 py-3 bg-white border-b border-gray-200 shrink-0">
              <Link href="/" className="flex items-center gap-2">
                <span className="w-8 h-8 bg-accent rounded-lg flex items-center justify-center text-primary font-bold text-xs">
                  IC
                </span>
                <span className="font-bold">IntermedCars</span>
              </Link>
              <div className="flex items-center gap-3">
                <Link href="/notificacoes" className="relative text-xl">
                  🔔
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
                    5
                  </span>
                </Link>
                <Link href="/chat" className="relative text-xl">
                  💬
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] w-4 h-4 rounded-full flex items-center justify-center">
                    3
                  </span>
